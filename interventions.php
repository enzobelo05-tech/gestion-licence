<?php 
    ...
    if(!empty($_POST["dateDebut"])) $requeteFinal->bindValue(":debut", $dateDebut);
    if(!empty($_POST["dateFin"])) $requeteFinal->bindValue(":fin", $dateFin);
    if(!empty($_POST["module"])) $requeteFinal->bindValue(":moduleId", $moduleID);
